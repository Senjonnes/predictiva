...
class AppColors {
  static const Color primaryColor = Color(0xFF3D02E6);
  static const Color card = Color(0xFFe9e4f9);
  static const Color white = Color(0xFFFFFFFF);
  static const Color semiWhite = Color(0xFFFDFDFD);
  static const Color black = Color(0xFF0D0D0F);
  ...
  static const Color deepGrey = Color(0xFF767676);
  static const Color boxesColor = Color(0xFF1C1C1C);
  ...
  static const Color successGreen = Color(0xFF10AE5A);
  static const Color errorRed = Color(0xFFE35055);
  static const Color orangeWarning = Color(0xFFF1AA28);
  static const Color orangeLight = Color(0xFFfEF0D2);
